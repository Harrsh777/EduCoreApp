/**
 * Session timeout for Student: 20 min, modal at ≤2 min, redirect to /student/login.
 */
...
export function useSessionTimeoutStudent(): SessionTimeoutContextValue | null {
  return useContext(SessionTimeoutContext);
}

export function SessionTimeoutProviderStudent({ children }: { children: ReactNode }) {
        ...
        <View style={styles.overlay}>
          <View style={styles.card}>
            ...
            <View style={styles.actions}>
              ...
              <Pressable style={[styles.btnPrimary, { backgroundColor: STUDENT_BLUE }]} onPress={handleStay}>
