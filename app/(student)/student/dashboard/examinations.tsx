...
const styles = StyleSheet.create({
  ...
  headerTitle: { ...textStyles.h4, color: TEXT, flex: 1, textAlign: 'center' },
  subtitle: {
    ...textStyles.bodySm,
    color: MUTED,
    textAlign: 'center',
  ...
  mutedText: { ...textStyles.body, color: MUTED, textAlign: 'center' },
  errorText: { ...textStyles.body, color: '#B91C1C', textAlign: 'center', marginTop: S.md },
  retryBtn: {
    marginTop: S.lg,
  ...
  heroTextCol: { flex: 1 },
  heroLabel: { ...textStyles.caption, color: MUTED, textTransform: 'uppercase', letterSpacing: 0.6 },
  heroTitle: { ...textStyles.h4, color: TEXT, marginTop: S.xs },
  heroMeta: { ...textStyles.bodySm, color: MUTED, marginTop: S.xs },
  heroNote: { ...textStyles.caption, color: MUTED, marginTop: S.sm, lineHeight: 18 },
  section: { marginBottom: S.xl },
  sectionTitle: { ...textStyles.h4, color: TEXT, marginBottom: S.xs },
  sectionHint: { ...textStyles.bodySm, color: MUTED, marginBottom: S.md },
  structureCard: {
    backgroundColor: CARD,
    borderRadius: RADIUS,
    borderWidth: 1,
  ...
  structureName: { ...textStyles.body, fontWeight: '700', color: TEXT },
  structureSub: { ...textStyles.caption, color: MUTED, marginTop: S.xs, lineHeight: 18 },
  structureBody: { marginTop: S.md },
  termBlock: { marginBottom: S.md },
  termLine: { ...textStyles.body, fontWeight: '600', color: TEXT },
  bulletList: { marginTop: S.xs, marginLeft: S.sm },
  bulletItem: { ...textStyles.bodySm, color: TEXT, marginTop: 4 },
  termEmpty: { ...textStyles.bodySm, color: MUTED },
  termEmptySm: { ...textStyles.caption, color: MUTED, marginTop: S.xs, fontStyle: 'italic' },
  examCard: {
    backgroundColor: CARD,
    borderRadius: RADIUS,
    padding: S.lg,
  ...
  examDateRange: { ...textStyles.bodySm, color: MUTED, marginTop: S.xs },
  examTitle: { ...textStyles.h4, color: TEXT },
  examDescription: { ...textStyles.bodySm, color: MUTED, marginBottom: S.md, lineHeight: 20 },
  ...
  badgeText: { ...textStyles.caption, color: PRIMARY, fontWeight: '700' },
  metaGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: S.md,
  ...
  metaLabel: { ...textStyles.caption, color: MUTED, fontWeight: '600' },
  metaValue: { ...textStyles.bodySm, color: TEXT, marginTop: 2, flexShrink: 1 },
  ...
  subjectCardTitle: { ...textStyles.body, fontWeight: '700', color: TEXT, marginBottom: S.sm },
  kvRow: {
    flexDirection: 'row',
    alignItems: 'flex-start',
    justifyContent: 'space-between',
  ...
  noSchedule: { ...textStyles.bodySm, color: MUTED, fontStyle: 'italic' },
  totalsFooter: { ...textStyles.caption, color: MUTED, marginTop: S.sm, fontWeight: '600' },
  amberBox: {
  ...
  amberText: { ...textStyles.bodySm, color: AMBER_TEXT, fontWeight: '600' },
  resultsBox: {
    marginTop: S.md,
    padding: S.md,
    borderRadius: 12,
  ...
  resultsTitle: { ...textStyles.body, fontWeight: '700', color: TEXT },
  resultsLine: { ...textStyles.bodySm, color: TEXT, marginTop: S.xs },
  ...
  remarksText: { ...textStyles.bodySm, color: MUTED, marginTop: S.sm },
  downloadBtnActive: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  emptyTitle: { ...textStyles.h4, color: TEXT, marginTop: S.md, textAlign: 'center' },
  emptyBody: { ...textStyles.bodySm, color: MUTED, textAlign: 'center', marginTop: S.sm, lineHeight: 20 },
});
