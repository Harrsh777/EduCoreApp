/**
 * Expense/Income: GET/POST /api/finance or /api/expense-income. Forms and lists.
 */
  ...
  return (
    <View style={styles.root}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        <Text style={styles.hint}>Expense and income entries. Use the web app for full forms and lists.</Text>
      </ScrollView>
    </View>
  );
}
